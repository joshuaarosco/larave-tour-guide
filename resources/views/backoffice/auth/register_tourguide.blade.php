...
@push('title','Tour Guide Registration')
        ...
        <form action="" method="POST" class="p-t-15" id="form-login" name="form-login" role="form">
          ...
          <div class="row">
            ...
            <div class="form-group form-group-default required {{$errors->has('nickname')?'has-error':null}}">
                ...
                <div class="controls">
                <input class="form-control" name="nickname" value="{{ old('nickname') }}" placeholder="Kuya Juan" required="" type="text">
                </div>
            </div>
