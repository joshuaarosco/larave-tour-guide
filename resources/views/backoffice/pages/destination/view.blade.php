        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h2 class="mw-80">{{ $destination? 'Update':'Create' }} Destination</h2>
                        <p class="fs-16 mw-80 m-b-40">Make an appealing content about the details of the destination.</p>
                        @include('backoffice.pages.destination._components.form')
                    </div>
                </div>
            </div>
        </div>
