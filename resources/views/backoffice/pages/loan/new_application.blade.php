    ...
    <div class=" container-fluid   container-fixed-lg">
        ...
        <form name="myForm" action="" method="POST" enctype="multipart/form-data">
            ...
            <div id="rootwizard" class="m-t-20">
                ...
                <li class="nav-item">
                    <a class="active d-flex align-items-center" data-toggle="tab" href="#tab2" data-target="#tab2" role="tab"><i class="material-icons fs-14 tab-icon">people</i> <span>Co-Borrower's Information</span></a>
                </li> 
                <li class="nav-item">
                    <a class="d-flex align-items-center" data-toggle="tab" href="#tab1" data-target="#tab1" role="tab"><i class="material-icons fs-14 tab-icon">credit_card</i> <span>Disbursement Details</span></a>
                </li>
                <li class="nav-item">
                    <a class="d-flex align-items-center" data-toggle="tab" href="#tab3" data-target="#tab3" role="tab"><i class="material-icons fs-14 tab-icon">payment</i> <span>Loan Detail</span></a>
                </li>
                <li class="nav-item">
                    <a class="d-flex align-items-center" id="tab-4" data-toggle="tab" href="#tab4" data-target="#tab4" role="tab"><i class="material-icons fs-14 tab-icon">done</i> <span>Summary</span></a>
                </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    ...
                    <div class="padding-20 sm-padding-5 sm-m-b-20 sm-m-t-20 bg-white clearfix">
                        ...
                        <li class="next">
                            <button aria-label="" class="btn btn-primary btn-cons from-left pull-right" id="btn-next" type="button">
                                <span>Next</span>
                            </button>
                        </li>
                        @if(!$loan)
...
<script>
    ...
    loanRate[{!!$loanType->id!!}] = "{!!$loanType->rate!!}";
    @endforeach
    ...
    function calculate(){
        ...
        console.log("LOAN-MONTH: "+loan_month);
        if(rate == 'annum'){
            amountWithInterest = (parseFloat(amount) * ((parseFloat(interest) * 12)/100)) + parseFloat(amount);
        }else{
            amountWithInterest = (parseFloat(amount) * ((parseFloat(interest) * loan_month)/100)) + parseFloat(amount);
        }
