            ...
            <!-- <form role="form"> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default required m-t-25">
                            ...
                            <input type="number" min="0" class="form-control" id="loan-month" name="oath_2" value="{{$loan?$loan->oath_2:old('oath_2', Input::has('oath_2')?Input::get('oath_2'):'' )}}" placeholder="Number of Months">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @else
                            <input type="hidden" id="loan-type" value="{{$loan->type_id}}">
                            @foreach($loanTypes as $index => $loanType)
