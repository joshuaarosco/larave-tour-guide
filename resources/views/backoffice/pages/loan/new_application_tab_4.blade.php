            ...
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td class=" col-md-3 text-right">
                        ...
                        @else
                        <span>₱ {{number_format($loan->oath_1, 2)}}</span>
                        @endif
                    </td>
                </tr>
                @if($loan)
                <tr>
                    <td class=" col-md-9">
                        <span class="m-l-10 font-montserrat fs-11 all-caps">Share Capital</span>
                    </td>
                    <td class=" col-md-3 text-right">
                        <span>₱ {{number_format($loan->oath_1 * 0.05, 2)}}</span>
                    </td>
                </tr>
                @endif
                <tr>
                ...
                <tr>
                    ...
                    <td class="col-md-3 text-right">
                        ...
                        @else
                        <h4 class="text-primary no-margin font-montserrat" id="loan-interest-txt">₱ {{number_format($loan->oath_5, 2)}}</h4>
                        @endif
                    </td>
                </tr>
            </table>
