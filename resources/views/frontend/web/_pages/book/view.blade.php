                    ...
                    <div class="col-xl-10">
                        <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                            <div class="bd-breadcrumb-content text-center">
                                <h1 class="bd-breadcrumb-title">{{ $tour->name }} <br><i>Booking Detail</i></h1>
                                ...
                                <div class="booking-form-input-wrapper">
                                        ...
                                        <div class="col-md-6">
                                            <div class="booking-form-input-box">
                                                ...
                                                <div class="booking-form-input">
                                                    <input name="fname" id="firstName" type="text" required readOnly
                                                        placeholder="" value="{{ $book->fname }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="booking-form-input-box">
                                                ...
                                                <div class="booking-form-input">
                                                    <input name="lname" id="nameLast" type="text" required readOnly
                                                        placeholder="" value="{{ $book->lname }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="booking-form-input-box">
                                        ...
                                        <div class="booking-form-input">
                                            <input name="email" id="email" type="email" autocomplete="email"
                                                required readOnly placeholder="Email address" value="{{ $book->email }}">
                                        </div>
                                    </div>
                                    <div class="booking-form-input-box">
                                        <div class="booking-form-input-title">
                                        ...
                                        <div class="booking-form-input">
                                            <input name="contact_number" id="mobileNumber" type="text" required readOnly
                                                placeholder="Contact Number" value="{{ $book->contact_number }}">
                                        </div>
                                    </div>
                                    <div class="booking-form-input-box">
                                        <div class="booking-form-input-title">
                                        ...
                                        <div class="booking-form-input">
                                            <input name="date" id="date" type="date" required readOnly
                                                placeholder="Date" value="{{ $book->date }}">
                                        </div>
                                    </div>
                                    <div class="booking-form-info mt-25">
                                        ...
                                        <div class="booking-form-input-box">
                                            ...
                                            <div class="booking-form-input">
                                                <input id="text" name="additional" type="text" value="{{ $book->additional }}" placeholder="" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
